        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"
                    className="pb-8 text-5xl font-thin tracking-tight lg:mt-10 lg:text-5xl" >Syed Abdul Rahman</motion.h1>
                    ...
                    initial="hidden"
                    animate="visible"
                    className="my-2 max-w-xl py-2 font-light tracking-tighter">{HERO_CONTENT}</motion.p>
                </div>
            </div>
